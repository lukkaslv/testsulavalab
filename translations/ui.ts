export const uiTranslations = {
    subtitle: "ГЕНЕЗИС СИСТЕМА // Зеркало Души",
    global: { back: "Назад", complete: "Завершен", calibrating: "Калибровка", calib_desc: "Настройка ядра..." },
    sync: { 
        title: "СКАНИРОВАНИЕ ТЕЛА", desc: "Где отозвался предыдущий вопрос?", connection_label: "СВЯЗЬ",
        scan_complete: "СИГНАЛ ПРИНЯТ",
        intro_title: "ВАШЕ ТЕЛО — ЭТО КОМПАС",
        intro_desc: "Эмоции и сопротивление проявляются как физические ощущения. Заметьте, где в теле 'отозвался' предыдущий вопрос. Это ключ к вашему подсознанию.",
    ...
    dashboard: { 
        ...
        manual_btn: "Инструкция", select_domain: "Сферы", signal_stability: "Стабильность сигнала", protocol_active: "ПРОТОКОЛ АКТИВЕН",
        ...
        domain_navigator: { title: "КАРТА СФЕР" }
    },
    onboarding: { 
        protocol_btn: "Старт", pricing_btn: "Доступ", promo_title: "Специальный Доступ", promo_desc: "Протоколы для экспертов", 
        recommended_tag: "Экспертам", price_per_month: "/мес", features_clinical: "Клиническое Досье;Нейронный След;Прогноз Альянса;Экспорт Слепка", 
    ...
    informed_consent: { 
        title: "ГЕНЕЗИС — Психодиагностический Инструмент",
        measures_title: "Что мы измеряем:", 
        measures: [
            "Задержки ваших ответов (латентность)", 
            "Телесные ощущения (соматика)", 
            "Паттерны сопротивления"
        ], 
        usage_title: "Как это будет использовано:", 
        usage: [
            "Специалист получит карту ваших поведенческих паттернов",
    ...
    ui: { 
        system_build: "СБОРКА", reset_session_btn: "Сброс", reset_confirm: "Стереть данные?", auth_title: "Вход", code_input_placeholder: "КЛИНИЧЕСКИЙ КОД", 
        ...
        progress_label: "Прогресс", system_audit_title: "Аудит системы", secured_label: "ЗАЩИЩЕНО", mode_client: "Клиент", mode_pro: "Специалист", 
        ...
        module_label: "СФЕРА", verdict_label: "Вердикт", priority_label: "Приоритет", access_restricted: "Доступ ограничен", enter_code_desc: "Введите код", 

...
import { AnalysisResult, Translations, SubscriptionTier, SessionStep } from '../../types';
...
const ProbabilityMatrix = ({ probs, t }: { probs: any, t: Translations }) => (
            ...
            {!clientResult ? (
                ...
                <div className="p-4 space-y-4 animate-in pb-32">
                    ...
                    <CollapsibleBlock title={ph.differential} icon="⚖️" badge={ph.badge_prob_map} isOpenDefault>
                         <ProbabilityMatrix probs={interpretation?.extra?.diffProb} t={t} />
                    </CollapsibleBlock>
